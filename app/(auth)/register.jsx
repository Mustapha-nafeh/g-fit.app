    ...
    mutate(
      { username, email, password },
      {
        onSuccess: (data) => {
          ...
          securestore.setItemAsync("token_key", data.token_key);
        },
        onError: (error) => {
      ...
      <View className="bg-background flex-1 px-6 pt-12">
        ...
        <View className="flex-1 justify-center">
          ...
          <View className="mb-12">
            <Text style={{ fontFamily: "MontserratAlternates_700Bold" }} className="text-white text-3xl text-left mb-2">
          ...
          <View className="mb-8">
            ...
            <TextInput
              ...
              className="w-full bg-gray-700/50 text-white py-4 px-6 rounded-2xl mb-4 text-base"
              autoCapitalize="none"
            />
            ...
            <View className="relative mb-4">
              <TextInput
                ...
                placeholderTextColor="#9CA3AF"
                style={{ fontFamily: "MontserratAlternates_400Regular" }}
                className="w-full bg-gray-700/50 text-white py-4 px-6 pr-12 rounded-2xl text-base"
          ...
          <TouchableOpacity
            ...
            className={`w-full py-4 px-6 rounded-2xl mb-8 ${
              isLoading || error !== "" || confirmPassword === "" ? "bg-gray-400" : "bg-gray-200 active:bg-white"
            }`}
            disabled={isLoading || error !== "" || confirmPassword === ""}
          >
            <Text
